'''File that initializes the pretrained VGG16 from the Keras library.
...
class Pretrained_VGG16():
  """
  Class that initializes the pre-trained VGG16 model from the keras library.
...
pretrainedVGG16 = Pretrained_VGG16()